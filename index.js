    ...
    context:
        async ({ req, res }) => {
            ...
            return { 
                ...
                cypherParams: {
                    user: user,
                    cypherMatchPrefix: `(public:Group {name:"public"}),(p:Person {pbotID:"${user.pbotID}"})-[:MEMBER_OF]->(g:Group)<-[:ELEMENT_OF|:MEMBER_OF]-`,
                    cypherMatchPostfix: `-[:ELEMENT_OF|:MEMBER_OF]->(group)<-[:MEMBER_OF]-(p) WHERE group IN [g,public]`,
