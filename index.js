...
const schema = makeAugmentedSchema({
      typeDefs: typeDefs,
      resolvers: Resolvers,
      //NOTE: had to add the following line to accomodate my custom query resolvers. I was getting errors like:
      //"Resolver for \"Reference.doi\" returned undefined". I don't know why I was getting those when the 
      //resolvers generated by neo4j-graphql-js weren't--they are processing the same data. Even weirder is 
      //that apollos makeExecutableSchema defaults this to true by default 
      //(https://deploy-preview-839--apollo-server-docs.netlify.app/docs/apollo-server/v2/api/graphql-tools.html), 
      //but neo4j-graphql-js's makeAugmentedSchema sets it to false 
      //(https://github.com/neo4j-graphql/neo4j-graphql-js/blob/master/docs/neo4j-graphql-js-api.md). So, the developer
      //of that package clearly processes undefined properties explicitly somewhere, but I can't find where.
